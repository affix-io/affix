...
import (
	...
	"github.com/affix-io/affix/api/util"
	"github.com/affix-io/affix/base/archive"
...
func GetBodyCSVHandler(inst *lib.Instance) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		p := &lib.GetParams{}
		if err := parseGetParamsFromRequest(r, p); err != nil {
...
func SaveByUploadHandler(inst *lib.Instance, routePrefix string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err := parseDatasetFromRequest(r, p.Dataset); err != nil {
			util.WriteErrResponse(w, http.StatusBadRequest, err)
			return
		}
