...
func init() {
	var err error
	testPeerProfile.PrivKey, err = key.DecodeB64PrivKey(testPk)
	if err != nil {
		panic(err)
	}
}
...
The process is outlined in [this blog post](https://medium.com/affix-io/taming-the-mtas-unruly-turnstile-data-c945f5f96ba0), and the code for the data pipeline is [available on github](https://github.com/affix-io/data-stories-scripts/tree/master/nyc-turnstile-counts).
