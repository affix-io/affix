...
import (
	...
	"github.com/affix-io/affix/transform"
	"github.com/affix-io/affix/transform/staticlark"
	"github.com/affix-io/dataset"
	"github.com/affix-io/dataset/preview"
...
func (automationImpl) Deploy(scope scope, p *DeployParams) error {
	...
	// affix connect is NOT running, we need a `wait` flag in DeployParams, that, when `true`,
